...
<section class="antialiased">
    ...
    <div
        class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 height-100vh sm:items-center py-4 sm:pt-0">
        @if (Route::has('login'))
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="cards">
                <div class="search">
                    ...
                    <button class="button button1"><svg stroke="currentColor" fill="currentColor" stroke-width="0"
                ...
                <div class="weather loading">
                    <h2 class="city">Weather in Singapore</h2>
                    <h1 class="temp">32°C</h1>
                    <div class="flex justify-left">
                        <img src="http://openweathermap.org/img/wn/04n@2x.png" alt="" class="icon" />
                        <div class="description">Sunny</div>
                    </div>

                    <div class="humidity">Humidity: 50%</div>
                    <div class="wind">Wind speed: 5km/h</div>
                </div>
            </div>
